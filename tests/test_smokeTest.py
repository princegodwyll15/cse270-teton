...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("prince")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Godwyll")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("PG Business")
